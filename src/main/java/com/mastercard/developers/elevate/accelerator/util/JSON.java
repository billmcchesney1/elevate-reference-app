...
public class JSON {
    ...
    private static final com.mastercard.developers.elevate.accelerator.generated.invokers.JSON INSTANCE = new com.mastercard.developers.elevate.accelerator.generated.invokers.JSON();
